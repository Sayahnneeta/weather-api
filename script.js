...
$.getWeather = function (city) {
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&APPID=25fad4b0fa53a3943b0b717292dbf797",
        function (data) {
            ...
            var windSpeed = (data.wind.speed)*3.2;
                windSpeed =windSpeed.toFixed(2) + "km/hr";
            ...
            $('.date').text($.date());
                 ...
                 else if(change>20 && change<35)
                 {
                     $("body").css("background-image","url(/medium.jpg)");
                 }
                 else if(change>=35)
                 {
